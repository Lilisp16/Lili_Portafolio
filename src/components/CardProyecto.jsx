...
export function CardProyecto({ proyecto }) {
  ...
  return (
    <div className="bg-white/40 backdrop-blur-md border border-white/30 rounded-lg flex flex-col shadow-md hover:scale-105 hover:shadow-xl transition-all duration-300">
      
      {/* Contenedor de la imagen */}
      <div className="relative h-48 bg-gray-200 rounded-t-lg flex items-center justify-center overflow-hidden">
        {imgProyecto ? (
          <img src={imgProyecto} alt={titulo} className="h-full w-full object-cover    transition-transform duration-500 hover:scale-110" />
        ) : (
        ...
        {/* Iconos web y github sobre la imagen */}
        {(web || github) && (
      ...
      <div className="p-6 flex flex-col justify-between flex-1">
        ...
        {/* Tecnologías */}
        {tecnologias && (
          <div className="flex flex-wrap gap-3 text-[#26DAEB] text-xl">
